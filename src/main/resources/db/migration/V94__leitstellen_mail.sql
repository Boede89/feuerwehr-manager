CREATE TABLE unit_leitstellen_mail_settings (
    ...
    subject_filter VARCHAR(255) NULL DEFAULT 'FAX',
    depesche_keywords VARCHAR(512) NOT NULL DEFAULT 'depesche,alarmdepesche',
    abschluss_keywords VARCHAR(512) NOT NULL DEFAULT 'abschluss,abschlussbericht',
