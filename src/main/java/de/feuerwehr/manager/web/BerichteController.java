...
public class BerichteController {
    ...
    public String startCheckInLegacy(
            @RequestParam(name = "unit") long unitId, @RequestParam(name = "terminId") long terminId) {
        return "redirect:/check-in?unit=" + unitId + "&terminId=" + terminId;
    }

    @GetMapping("/anwesenheitslisten/{id}/check-in")
    public String resumeCheckInLegacy(@RequestParam(name = "unit") long unitId, @PathVariable long id) {
